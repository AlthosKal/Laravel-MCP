...
class OllamaService
{
    ...
    public function isAvailable(): bool
    {
        try {
            ...
            $this->logger->error('Ollama no está disponible', ['error' => $e->getMessage()]);
            return false;
        }
    }
    ...
    public function listModels(): array
    {
        try {
            ...
            $this->logger->error('Error al listar modelos', ['error' => $e->getMessage()]);
            return [];
        }
    }
    ...
    public function generate(string $prompt, array $options = []): ?string
    {
        try {
            ...
            $this->logger->error('Error al generar respuesta', ['error' => $e->getMessage()]);
            return null;
        }
    }
