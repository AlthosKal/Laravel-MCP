<template>
    <div class="flex flex-col h-screen max-w-6xl mx-auto">
        ...
        <div class="flex-1 flex overflow-hidden">
                ...
                >
                    ...
                    <div v-if="messages.length === 0" class="text-center py-12">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                            Ask questions about uploaded documents, perform calculations, or chat naturally. Try "add 5 and 3" or upload documents to get started!
                        </p>
                    </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <!-- RAG Context Sources -->
                            <div
                                v-if="message.metadata && message.metadata.rag_sources"
                            ...
                            >
                                ...
                                <div class="space-y-1">
                                    <div
                                        v-for="(source, idx) in message.metadata.rag_sources"
                                        :key="idx"
            ...
            <!-- Documents Panel (Sidebar) -->
            <aside
                v-if="showDocumentsPanel"
                class="w-96 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 overflow-y-auto"
            >
                <div class="p-6">
            ...
            <!-- Tools Panel (Sidebar) -->
            <aside
                v-if="showToolsPanel && !showDocumentsPanel"
