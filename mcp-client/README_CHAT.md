...
McpClientInterface ← McpClientRepository (stub - no MCP client configured)
DocumentService ← McpRagClientService (RAG operations)
```
...
│   ├── OllamaService.php
│   ├── McpRagClientService.php  # RAG client
│   └── DocumentService.php
└── Http/Controllers/
